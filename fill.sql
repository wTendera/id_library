BEGIN;
  ...
  SELECT add_new_borrow(111, 'Krew elfów', 1, now()-interval '3 weeks', NULL);
  SELECT add_new_borrow(25, 'Wieża jaskółki', 4, now()-interval '7 week', NULL);
  SELECT add_new_borrow(78, 'Ostatnie życzenie', 5, now()-interval '5 weeks', NULL);
  SELECT add_new_borrow(17, 'Pani jeziora', 7, now()-interval '1 week', NULL);
  SELECT add_new_borrow(98, 'Miecz przeznaczenia', 1, now()-interval '2 weeks', NULL);
  SELECT add_new_borrow(56, 'Czas pogardy', 2, now()-interval '1 day', NULL);
  SELECT add_new_borrow(57, 'Atlas chmur', 7, now()-interval '4 weeks', NULL);
  SELECT add_new_borrow(23, 'Kolor purpury', 2, now()-interval '3 weeks', NULL);
  SELECT add_new_borrow(11, 'Okruchy dnia', 1, now()-interval '12 weeks', NULL);
  SELECT add_new_borrow(99, 'Pani Bovary', 2, now()-interval '1 week', NULL);

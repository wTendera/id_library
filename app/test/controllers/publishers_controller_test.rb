...
class PublishersControllerTest < ActionController::TestCase
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post :create, publisher: { address: @publisher.address, creation_date: @publisher.creation_date, phone_num: @publisher.phone_num, publisher_name: @publisher.publisher_name }
    end
  ...
  test "should update publisher" do
    patch :update, id: @publisher, publisher: { address: @publisher.address, creation_date: @publisher.creation_date, phone_num: @publisher.phone_num, publisher_name: @publisher.publisher_name }
    assert_redirected_to publisher_path(assigns(:publisher))
  end

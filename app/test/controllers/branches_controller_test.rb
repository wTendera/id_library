...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address: @branch.address, branch_name: @branch.branch_name, phone_num: @branch.phone_num }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { address: @branch.address, branch_name: @branch.branch_name, phone_num: @branch.phone_num }
    assert_redirected_to branch_path(assigns(:branch))
  end
